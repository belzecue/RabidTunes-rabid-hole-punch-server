...
ERR_INVALID_SESSION_NAME = "error:invalid_session_name"
ERR_INVALID_PLAYER_NAME = "error:invalid_player_name"
ERR_INVALID_MAX_PLAYERS = "error:invalid_max_players"
ERR_INVALID_SESSION_PASSWORD = "error:invalid_session_password"
...
ERR_PLAYER_ADDRESS_EXIT_MISMATCH = "error:player_address_exit_mismatch"
ERR_PLAYER_TIMEOUT = "error:player_timeout"
ERR_PLAYER_ADDRESS_MISMATCH = "error:player_address_mismatch"
